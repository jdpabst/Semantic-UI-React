...
export default class Visibility extends Component {
  ...
  fire = ({ callback, name }, value, reverse = false) => {
    ...
    // - calculation values are different
    const matchesDirection = this.calculations[value] !== reverse
    const calculationEqual = this.calculations[value] === this.oldCalculations[value]

    if (matchesDirection && !calculationEqual) this.execute(callback, name)
